...
class _DeliveredScreenState extends State<DeliveredScreen> {
  ...
  void initState() {
    ...
    final orderProvider = Provider.of<DeliveredProvider>(context, listen: false);
    ...
    controller.addListener(() {
      if (controller.position.maxScrollExtent == controller.offset) {
        context.read<DeliveredProvider>().addOrder().catchError((error) {
          showMyAlertDialog(context, error.toString());
        });
      }
    });
  ...
  Widget build(BuildContext context) {
    final orderProvider = Provider.of<DeliveredProvider>(context);
