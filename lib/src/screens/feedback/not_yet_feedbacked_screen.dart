...
class NotYetFeedbackedScreen extends StatefulWidget {
  const NotYetFeedbackedScreen({Key? key}) : super(key: key);

  @override
  State<NotYetFeedbackedScreen> createState() => _NotYetFeedbackedScreenState();
}

class _NotYetFeedbackedScreenState extends State<NotYetFeedbackedScreen> {
  ...
  void initState() {
    ...
    final feedbacksProvider =
        Provider.of<NotYetFeedbackProvider>(context, listen: false);
    ...
    controller.addListener(() {
      if (controller.position.maxScrollExtent == controller.offset) {
        context.read<NotYetFeedbackProvider>().addData();
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    final ratedProvider = Provider.of<NotYetFeedbackProvider>(context);
    return Scaffold(
      body: _isLoading
          ? const Center(
