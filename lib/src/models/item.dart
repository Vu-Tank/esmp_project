...
class Item {
  ...
  @override
  String toString() {
    return 'Item{itemID: $itemID, name: $name, description: $description, discount: $discount, rate: $rate, price: $price, itemImage: $itemImage, province: $province}';
  }
}
...
class ItemDetail {
  ...
  @override
  String toString() {
    return 'ItemDetail{itemID: $itemID, name: $name, description: $description, rate: $rate, maxPrice: $maxPrice, minPrice: $minPrice, discount: $discount, createDate: $createDate, listImage: $listImage, listSpecification: $listSpecification, store: $store, listSubItem: $listSubItem, listMotorBrand: $listMotorBrand}';
  }
}
