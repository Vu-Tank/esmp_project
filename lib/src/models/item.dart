...
class ItemDetail {
  ...
  factory ItemDetail.fromJson(Map<String, dynamic> json) {
    return ItemDetail(
      ...
      listImage: (json['list_Image'] as List)
          .map((image) => ImageModel.fromJson(image))
          .toList(),
      listSpecification: (json['specification_Tag'] as List)
          .map((specification) => SpecificationItem.fromJson(specification))
          .toList(),
      store: Store.fromJson(json['store']),
      listSubItem: (json['listSubItem'] as List)
          .map((subItem) => SubItem.fromJson(subItem))
          .toList(),
      listMotorBrand: (json['listModel'] as List)
          .map((motorBrand) => MotorBrand.fromJson(motorBrand))
          .toList(),
    );
  }
  ...
  @override
  String toString() {
    return 'ItemDetail{itemID: $itemID, name: $name, description: $description, rate: $rate, maxPrice: $maxPrice, minPrice: $minPrice, discount: $discount, numSold: $numSold, createDate: $createDate, listImage: $listImage, listSpecification: $listSpecification, store: $store, listSubItem: $listSubItem, listMotorBrand: $listMotorBrand}';
  }
}
